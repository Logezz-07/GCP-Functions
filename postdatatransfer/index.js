...
functions.http("helloHttp", async (req, res) => {
    ...
    try {
        ...
        const apiUrl = `https://dev01-cct.rogers.com/dev01-cctdtapi/data-transfer/1.0.0/datatransfer/${transferId}?callingSystem=${callingSystem}`;
